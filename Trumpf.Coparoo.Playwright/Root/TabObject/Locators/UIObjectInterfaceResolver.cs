...
{
    private static readonly ConcurrentDictionary<Type, Type> resolveCache = new();
    ...
    private Type ResolveControlType(Type toResolve, bool retryOnce)
    {
        ...
        {
            controlTypesCache = controlTypesCache ?? Locate.ControlObjectTypes.Where(e => e.IsAssignableFrom(e)).ToArray();
