...
/// <summary>
/// Text area control object.
/// Expects a textarea html element.
/// </summary>
public class TextArea : ControlObject, ITextArea
{
    /// <summary>
    /// Gets the search pattern.
    /// </summary>
    protected override By SearchPattern => "textarea";

    /// <summary>
    /// Gets or sets the name.
    /// </summary>
    public async Task<string> GetName()
         => await Locator.EvaluateAsync<string>("input => input.name");

    /// <summary>
    /// Gets or sets the text.
    /// </summary>
    public async Task<string> GetValue()
         => await Locator.EvaluateAsync<string>("input => input.value");
