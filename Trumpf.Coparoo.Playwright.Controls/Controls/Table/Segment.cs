...
/// </summary>
public abstract class Segment : ControlObject, ISegment
{
    /// <summary>
    /// Gets the enumeration of row control objects.
    /// </summary>
    public IAsyncEnumerable<IRow> Rows => FindAll<Row>();
    ...
    public async Task<IRow> RowAt(int index) => await Rows.ElementAtAsync(index);
}