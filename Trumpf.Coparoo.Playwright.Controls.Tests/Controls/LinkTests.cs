...
public class LinkTests
{
    ...
    public async Task WhenALinkIsAccessed_ThenItCanBeFoundAndThePropertiesFit()
    {
        ...
        var tab = await TestTab.CreateTestPageAsync($"<a href=\"{expectedLinkUrl}\">{expectedLinkText}</a>");
    ...
    public async Task WhenTwoLinksExist_ThenTheyCanBeRetrieved()
    {
        ...
        var tab = await TestTab.CreateTestPageAsync($"<a href=\"{firstExpectedLinkUrl}\">{firstExpectedLinkText}</a><a href=\"{secondExpectedLinkUrl}\">{secondExpectedLinkText}</a>");
