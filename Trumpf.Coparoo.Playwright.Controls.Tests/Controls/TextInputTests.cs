...
public class TextInputTests
{
    ...
    public async Task WhenATextInputIsAccessed_ThenItCanBeFoundAndThePropertiesFit()
    {
        ...
        var tab = await TestTab.CreateTestPageAsync(HtmlContents(expectedName, expectedValue));
    ...
    public async Task WhenATextInputIsSet_ThenTheNewValueCanAlsoBeRetrieved()
    {
        ...
        var tab = await TestTab.CreateTestPageAsync(HtmlContents(expectedName, originalValue));
